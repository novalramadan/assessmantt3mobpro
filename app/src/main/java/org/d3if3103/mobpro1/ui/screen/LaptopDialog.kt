        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = stringResource(id = R.string.spesifikasi)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(nama_barang, spesifikasi) },
                        enabled = nama_barang.isNotEmpty() && spesifikasi.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
